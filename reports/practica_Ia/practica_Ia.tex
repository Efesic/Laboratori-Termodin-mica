...
\begin{Figura}
  \centering
  \captionof{table}{\footnotesize{Valors ajustats per a una regressió lineal, amb model $y = mx + b$, on $y$ és el logaritme de les temperatures mitjanes i $x$ les posicions $x_i$.}}
  \begin{tabular}{c|c|c}
...
\begin{Figura}
  \centering
  \captionof{table}{\footnotesize{pendents de les regressions (valor de m)}}
  \begin{tabular}{c|c|c}
    a & a & a \\
    b & b & b 
  \end{tabular}
